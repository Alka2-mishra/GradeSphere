        ...
        <section className="relative overflow-hidden py-24 px-6">
          ...
          <div className="max-w-4xl mx-auto text-center relative">
            ...
            <h1 className="text-5xl md:text-6xl font-extrabold tracking-tight mb-6 leading-tight">
              Welcome to <span className="text-primary">GradeSphere</span>
            </h1>
            ...
            <div className="grid sm:grid-cols-2 gap-6 max-w-2xl mx-auto">
              ...
              >
                ...
                <CardContent>
                  ...
                  <Button className="w-full group/btn" size="lg" onClick={() => navigate("/login?role=student")}>
                    Login as Student
              ...
              >
                ...
                <CardContent>
                  ...
                  <Button className="w-full group/btn" size="lg" variant="outline" onClick={() => navigate("/login?role=teacher")}>
                    Login as Teacher
                    <ArrowRight className="w-4 h-4 group-hover/btn:translate-x-1 transition-transform" />
                  </Button>
                </CardContent>
            ...
            <p className="mt-6 text-sm text-muted-foreground">
              New here?{" "}
              <a href="#" className="text-primary font-medium hover:underline">Create a free account</a>
            </p>
          </div>
        </section>
